...
Item {
    ...
    Popup{
        ...
        Button {
            ...
            Material.foreground: "#FFFFFF"
            onClicked: {
                excelconnection.saveWarehouseinfo(fileDialogIn.fileUrl)
                previewPopup.close()
                refresh1()
            }
        }
    ...
    ToolBar {
        ...
        FileDialog {
            ...
            onAccepted: {
                ...
                excelconnection.dbtoExcel(9, fileDialogOut.fileUrl)
            }
            onRejected: {
        ...
        FileDialog {
            ...
            onAccepted: {
                ...
                premodel.clear()
                var list = excelconnection.openWarehouseinfo(fileDialogIn.fileUrl)
                for(var i = 0; i < list.length; i++){
                    premodel.append({"warehouseID": list[i].getWarehouseID,
                                      "userID": list[i].getUserID,
                                      "address": list[i].getAddress})
                }
